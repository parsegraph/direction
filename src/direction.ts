...
import Direction, {
    NUM_DIRECTIONS, Axis, HORIZONTAL_ORDER, VERTICAL_ORDER,
    readDirection, nameDirection, isDirection, reverseDirection,
    turnLeft, turnRight, turnNegative, turnPositive,
    isCardinalDirection, nameAxis, getDirectionAxis,
    isVerticalDirection, isHorizontalDirection, getPerpendicularAxis,
    getPositiveDirection, getNegativeDirection, forEachCardinalDirection,
...
export {
    ...
    PreferredAxis,
    namePreferredAxis,
    readPreferredAxis, Direction, NUM_DIRECTIONS, Axis,
    HORIZONTAL_ORDER, VERTICAL_ORDER, readDirection,
    nameDirection, isDirection, reverseDirection,
    turnLeft, turnRight, turnNegative, turnPositive,
    isCardinalDirection, nameAxis, getDirectionAxis,
    isVerticalDirection, isHorizontalDirection,
