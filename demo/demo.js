...
app.get('/', async (req, res) => {
  ...
  write(`<html>`);
  write(`<head>`);
  write(`<title>direction</title>`);
  write(`</head>`);
  write(`<body>`);
  write(`<h1>direction <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`);
  write(`<p>This library is available as JavaScript UMD module: <a href='/direction.js'>direction.js</a></p>`);
